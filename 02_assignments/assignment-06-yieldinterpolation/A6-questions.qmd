...
- Deadline is Wednesday Feb 25 11:59 pm (we will use all 3 interpolated cleaned yield data on our next steps). 
...
After answering all questions, include your last name on the file name (e.g., A6-questions-Bastos.qmd), render it, and upload the .html to eLC by **Wednesday, Feb 25 11:59 pm**.  
